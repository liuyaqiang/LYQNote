...
{
    NSString *RACSiganalTestStr, *RACSubjectTestStr , *RACReplaySubjectTestStr, *RACSequenceTestStr, *RACCommandTestStr;
}
...
- (NSArray *)dataArr
{
    RACSiganalTestStr = @"RACSiganalTest", RACSubjectTestStr = @"RACSubjectTest", RACReplaySubjectTestStr = @"RACReplaySubjectTest" ,RACSequenceTestStr = @"RACSequenceTest", RACCommandTestStr = @"RACCommandTest";
    if (!_dataArr) {
        _dataArr = @[
                     @[RACSiganalTestStr],
                     @[RACSubjectTestStr],
